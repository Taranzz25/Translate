...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyInputText = findViewById(R.id.InputText);
        MyTarget = findViewById(R.id.Target);
        MyTranslateButton = findViewById(R.id.TranslateButton);
        MyOutputText = findViewById(R.id.OutputText);
        ...
        MyTranslateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                MyTarget.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                                                       @Override
                                                       public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                                                          String lang= adapterView.getItemAtPosition(i).toString();
                                                          Target = findLangCode(lang.toUpperCase());
